  ...
  const roadmapVersions: RoadmapVersion[] = [
    ...
    },
    {
      ...
      tasks: [
        ...
        { title: 'SVG Rendering Engine', status: 'completed' },
        ...
        { title: 'Color Picker', status: 'in-progress' },
        { title: 'Editor/Color/Mixer Mode', status: 'not-started' },
        { title: 'Themes System', status: 'completed' },
        { title: 'Workspace Colors', status: 'completed' },
        { title: 'Font Importer', status: 'in-progress' },
        { title: 'Icons Library (Object)', status: 'in-progress' },
        ...
        { title: 'Command Palette', status: 'completed' },
        { title: 'Layers System', status: 'in-progress' },
        { title: 'Rulers & Measurements', status: 'not-started' },
        { title: 'Magnetic Guidelines', status: 'not-started' },
        { title: 'Export with Transparency', status: 'completed' },
        { title: 'GIF Support', status: 'in-progress' },
        { title: 'Right-click Menu Actions', status: 'not-started' },
        { title: 'Video Support', status: 'in-progress' },
        { title: 'Auto-align', status: 'not-started' },
        { title: 'Object Lock', status: 'not-started' },
        { title: 'Offline Mode', status: 'not-started' },
        { title: 'Customizable Toolbar', status: 'completed' },
        { title: 'Branching System', status: 'not-started' },
        { title: 'Canvas Objects (500 Free)', status: 'completed' },
        { title: 'Data Visualization Object', status: 'not-started' },
        { title: 'Iframe Object', status: 'completed' },
        { title: 'Stickers Object', status: 'completed' },
        ...
        { title: 'Easy Image Import (Drag & Drop - PRO)', status: 'completed' },
        { title: 'Cloud Storage & Sync (PRO)', status: 'in-progress' },
