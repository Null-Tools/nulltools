  ...
  const roadmapVersions: RoadmapVersion[] = [
    {
      ...
      tasks: [
        ...
        { title: 'API Documentation', status: 'not-started' },
        { title: 'Advanced Search', status: 'not-started' },
        { title: 'UI Refresh', status: 'not-started' },
        { title: 'Mobile Experience Improvements', status: 'not-started' },
        { title: 'Tags', status: 'not-started' },
        { title: 'More File Previews', status: 'not-started' },
        { title: 'Python SDK', status: 'not-started' },
    ...
    },
    {
      ...
      tasks: [
        ...
        { title: 'Null OAuth Button', status: 'in-progress' },
